...
function search() {
    ...
    var url = "https://kyfw.12306.cn/otn/leftTicket/queryA?leftTicketDTO.train_date=" + year + "-" + month + "-" + day + "&leftTicketDTO.from_station=" + departureStation + "&leftTicketDTO.to_station=" + terminalStation + "&purpose_codes=ADULT"
